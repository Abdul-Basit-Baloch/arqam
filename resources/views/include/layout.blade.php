...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="{{route('index')}}">Dar-e-Arqam<span>.</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Audios</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              
              <li><a href="#">Darse Quran</a></li>
              <li><a href="#">Darse Hadees</a></li>
              <li><a href="#">Darse Seerat</a></li>
              <li><a href="#">Darse Fiqh</a></li>
