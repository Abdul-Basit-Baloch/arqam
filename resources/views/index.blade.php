...
<head>
  ...
  <title>Madrasa Dar-e-Arqam Official Website</title>
...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">abdulmateen989@yahoo.com</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+92 304 2632096</span></i>
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="{{('index')}}">Dar-e-Arqam<span>.</span></a></h1>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Audio</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="#">Hadees</a></li>
              <li><a href="#">Seerat</a></li>
              <li><a href="#">Fiqh</a></li>
    ...
    <section id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Each Subject has a separate specialist</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              <h3 class="btn-buy">Level one</h3><br>
              <span class="btn-wrap">Duration 6 Months</span>
              <ul>
                <li>Tajweed</li>
                <li>Tahleemul Islam</li>
                <li>Tafseer</li>
                <li>Basic Arabic Grammer</li>
                <li>Arabic conversation</li>
              </ul>
              <div class="btn-wrap">
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Lyari Nawalane<br>
              Pakistan <br><br>
              <strong>Phone:</strong> +92 304 2632096 <br>
              <strong>Email:</strong> abdulmateen989@yahoo.com<br>
            </p>
          </div>
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Madrasa Dar-e-Arqam</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
